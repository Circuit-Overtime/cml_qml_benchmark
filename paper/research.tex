...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{figures/VQC.jpg}
...
TODO: QSVM description.

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{figures/QSVM.jpg}
\caption{Quantum circuit for the ZZFeatureMap used in the QSVM kernel.}
\label{fig:QSVM}
\end{figure}
...
TODO: QNB description.

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.7\linewidth]{figures/QNB.jpg}
\caption{Quantum circuit for the Quantum Hybrid Naive Bayes model.}
\label{fig:QNB}
\end{figure}
