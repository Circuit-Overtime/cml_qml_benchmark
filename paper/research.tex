...
\item A comparative analysis of 7 supervised ML algorithms for ASD trait prediction, identifying HGBC as the best classical model and QSVM as the best quantum model.
\item Introduction of three Quantum Machine Learning models---VQC, QSVM, and QNB---to evaluate QML's performance in capturing non-linear feature relationships.
