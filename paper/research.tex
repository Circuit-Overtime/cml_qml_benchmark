...
This section highlights the clear separation in performance between classical ensemble approaches (RF, HGBC) and quantum models (QSVM, VQC, QNB). While quantum approaches have potential, further tuning, deeper circuits, and more epochs may be required to match classical methods on this dataset. All three quantum models were evaluated on the same PCA-reduced test set (749 samples) using the identical 80/20 stratified split \cite{bishop2006}.
...
\begin{table}[!ht]
    ...
    \begin{tabular}{|c|l|c|c|c|c|}
        ...
        \hline
          ...
          \hline
          17 & Q->NB & 63.28 & 64.96 & 67.09 & 66.01 \\
          \hline
    \end{tabular}
...
Within the quantum models, QSVM achieved the highest quantum accuracy at 82.00\%, followed by VQC at 74.50\% and Q$\rightarrow$NB at 63.28\%. The lower QNB performance reflects the inherent limitation of parameterless quantum feature maps: without trainable circuit parameters, the quantum transformation relies entirely on fixed data encoding and entanglement to separate classes, which proves insufficient on PCA-reduced features. These results indicate that, with optimized quantum encodings and suitable hardware, QML approaches hold potential for modeling complex non-linear relationships even at smaller scales.
