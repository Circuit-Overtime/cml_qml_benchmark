...
\centering
\includegraphics[width=0.9\linewidth]{VQC.jpg}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=0.95\linewidth]{QSVM.jpg}
...
\centering
\includegraphics[width=\linewidth]{QNB.jpg}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.95\linewidth]{ml_graph/pr_re_gh/pr_re_vcq.jpg}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.95\linewidth]{ml_graph/pr_re_gh/pr_re_qsvm.jpg}
...
\begin{minipage}{0.49\textwidth}
  \centering
    \includegraphics[width=1\linewidth]{ml_graph/DS/f1_score.jpeg}
