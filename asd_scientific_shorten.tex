...
\begin{itemize}
    ...
    Therefore, for QML models, \textbf{Principal Component Analysis (PCA)} was applied to the scaled dataset to reduce it to a low-dimensional latent space. After experimentation, a reduced dimensionality of **4 principal components** was selected, balancing:
...
\begin{minipage}{0.48\textwidth}
   \centering
    \includegraphics[width=0.9\linewidth]{ml_graph/precision and recall ml_graph/pre_re_rf.jpeg}
...
\hfill % Adds horizontal space between minipages
   \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ml_graph/precision and recall ml_graph/pre_re_svm.jpeg}
