...
\begin{minipage}{0.48\textwidth}
   \centering
    \includegraphics[width=0.9\linewidth]{ml_graph/pr_re_gh/pre_re_rf.jpeg}
...
\hfill % Adds horizontal space between minipages
   \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ml_graph/pr_re_gh/pre_re_svm.jpeg}
