...
- [x] 8. Replace VQLR with VQC; improve circuit descriptions; expand U(θ) and measurement explanations
...
- [x] 13. Clarify which part of the dataset is used for ML vs EDA
